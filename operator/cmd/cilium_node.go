...
import (
	...
	v2 "github.com/khulnasoft/shipyard/pkg/k8s/client/clientset/versioned/typed/cilium.io/v2"
	"github.com/khulnasoft/shipyard/pkg/k8s/informer"
	v1 "github.com/khulnasoft/shipyard/pkg/k8s/slim/k8s/apis/meta/v1"
