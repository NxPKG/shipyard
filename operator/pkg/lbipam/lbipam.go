...
import (
	...
	"github.com/khulnasoft/shipyard/pkg/ipam/service/ipallocator"
	"github.com/khulnasoft/shipyard/pkg/k8s"
	cilium_api_v2alpha1 "github.com/khulnasoft/shipyard/pkg/k8s/apis/cilium.io/v2alpha1"
	cilium_client_v2alpha1 "github.com/khulnasoft/shipyard/pkg/k8s/client/clientset/versioned/typed/cilium.io/v2alpha1"
	"github.com/khulnasoft/shipyard/pkg/k8s/resource"
	slim_core_v1 "github.com/khulnasoft/shipyard/pkg/k8s/slim/k8s/api/core/v1"
	slim_meta "github.com/khulnasoft/shipyard/pkg/k8s/slim/k8s/apis/api/meta"
	slim_meta_v1 "github.com/khulnasoft/shipyard/pkg/k8s/slim/k8s/apis/meta/v1"
	client_typed_v1 "github.com/khulnasoft/shipyard/pkg/k8s/slim/k8s/client/clientset/versioned/typed/core/v1"
