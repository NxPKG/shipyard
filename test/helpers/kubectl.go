...
import (
	...
	cnpv2 "github.com/khulnasoft/shipyard/pkg/k8s/apis/cilium.io/v2"
	"github.com/khulnasoft/shipyard/pkg/k8s/synced"
	"github.com/khulnasoft/shipyard/test/config"
	ginkgoext "github.com/khulnasoft/shipyard/test/ginkgo-ext"
	"github.com/khulnasoft/shipyard/test/helpers/logutils"
)
...
func (kub *Kubectl) CiliumExecContext(ctx context.Context, pod string, cmd string) *CmdRes {
	...
	// https://github.com/khulnasoft/shipyard/issues/22476
...
func (kub *Kubectl) CollectSysdump(ctx context.Context) {
	...
	// support absolute path. Once https://github.com/khulnasoft/shipyard-cli/pull/1552
