...
import (
	...
	k8sConst "github.com/khulnasoft/shipyard/pkg/k8s/apis/cilium.io"
	"github.com/khulnasoft/shipyard/pkg/versioncheck"
	ginkgoext "github.com/khulnasoft/shipyard/test/ginkgo-ext"
)
...
const (
	...
	CiliumPath = "/src/github.com/khulnasoft/shipyard/test"
	...
	segmentationFault   = "segmentation fault"                                       // from https://github.com/khulnasoft/shipyard/issues/3233
	NACKreceived        = "NACK received for version"                                // from https://github.com/khulnasoft/shipyard/issues/4003
	RunInitFailed       = "JoinEP: "                                                 // from https://github.com/khulnasoft/shipyard/pull/5052
	sizeMismatch        = "size mismatch for BPF map"                                // from https://github.com/khulnasoft/shipyard/issues/7851
	RemovingMapMsg      = "Removing map to allow for property upgrade"               // from https://github.com/khulnasoft/shipyard/pull/10626
	logBufferMessage    = "Log buffer too small to dump verifier log"                // from https://github.com/khulnasoft/shipyard/issues/10517
	ClangErrorsMsg      = " errors generated."                                       // from https://github.com/khulnasoft/shipyard/issues/10857
	ClangErrorMsg       = "1 error generated."                                       // from https://github.com/khulnasoft/shipyard/issues/10857
	symbolSubstitution  = "Skipping symbol substitution"                             //
	uninitializedRegen  = "Uninitialized regeneration level"                         // from https://github.com/khulnasoft/shipyard/pull/10949
	unstableStat        = "BUG: stat() has unstable behavior"                        // from https://github.com/khulnasoft/shipyard/pull/11028
	removeTransientRule = "Unable to process chain CILIUM_TRANSIENT_FORWARD with ip" // from https://github.com/khulnasoft/shipyard/issues/11276
	missingIptablesWait = "Missing iptables wait arg (-w):"
	localIDRestoreFail  = "Could not restore all CIDR identities" // from https://github.com/khulnasoft/shipyard/pull/19556
	...
	opCantBeFulfilled          = "Operation cannot be fulfilled on leases.coordination.k8s.io"        // cf. https://github.com/khulnasoft/shipyard/issues/16402
	initLeaderElection         = "error initially creating leader election record: leases."           // cf. https://github.com/khulnasoft/shipyard/issues/16402#issuecomment-861544964
	globalDataSupport          = "kernel doesn't support global data"                                 // cf. https://github.com/khulnasoft/shipyard/issues/16418
	removeInexistentID         = "removing identity not added to the identity manager!"               // cf. https://github.com/khulnasoft/shipyard/issues/16419
	failedToListCRDs           = "the server could not find the requested resource"                   // cf. https://github.com/khulnasoft/shipyard/issues/16425
	retrieveResLock            = "retrieving resource lock kube-system/cilium-operator-resource-lock" // cf. https://github.com/khulnasoft/shipyard/issues/16402#issuecomment-871155492
	failedToRelLockEmptyName   = "Failed to release lock: resource name may not be empty"             // cf. https://github.com/khulnasoft/shipyard/issues/16402#issuecomment-985819560
