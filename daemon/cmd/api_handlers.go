...
import (
	...
	"github.com/khulnasoft/shipyard/api/v1/server/restapi/bgp"
	"github.com/khulnasoft/shipyard/api/v1/server/restapi/daemon"
	"github.com/khulnasoft/shipyard/api/v1/server/restapi/endpoint"
	"github.com/khulnasoft/shipyard/api/v1/server/restapi/ipam"
	"github.com/khulnasoft/shipyard/api/v1/server/restapi/metrics"
	"github.com/khulnasoft/shipyard/api/v1/server/restapi/policy"
	"github.com/khulnasoft/shipyard/api/v1/server/restapi/prefilter"
	"github.com/khulnasoft/shipyard/api/v1/server/restapi/recorder"
