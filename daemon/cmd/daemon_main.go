...
import (
	...
	healthApi "github.com/khulnasoft/shipyard/api/v1/health/server"
	"github.com/khulnasoft/shipyard/api/v1/server"
	...
	"github.com/khulnasoft/shipyard/pkg/components"
	"github.com/khulnasoft/shipyard/pkg/controller"
	"github.com/khulnasoft/shipyard/pkg/crypto/certificatemanager"
	...
	"github.com/khulnasoft/shipyard/pkg/datapath/maps"
	...
	"github.com/khulnasoft/shipyard/pkg/flowdebug"
	"github.com/khulnasoft/shipyard/pkg/hive"
	"github.com/khulnasoft/shipyard/pkg/hive/cell"
	"github.com/khulnasoft/shipyard/pkg/hubble/exporter/exporteroption"
	"github.com/khulnasoft/shipyard/pkg/hubble/observer/observeroption"
	...
	"github.com/khulnasoft/shipyard/pkg/ipmasq"
	"github.com/khulnasoft/shipyard/pkg/k8s"
	k8sClient "github.com/khulnasoft/shipyard/pkg/k8s/client"
	"github.com/khulnasoft/shipyard/pkg/k8s/watchers/resources"
	...
	"github.com/khulnasoft/shipyard/pkg/pidfile"
	...
	"github.com/khulnasoft/shipyard/pkg/sysctl"
	"github.com/khulnasoft/shipyard/pkg/version"
	wireguard "github.com/khulnasoft/shipyard/pkg/wireguard/agent"
)
...
func InitGlobalFlags(cmd *cobra.Command, vp *viper.Viper) {
	...
	// See https://github.com/khulnasoft/shipyard/pull/20282 for more information.
...
func initEnv(vp *viper.Viper) {
	...
	if option.Config.IPAM == ipamOption.IPAMAzure {
		...
		log.WithFields(logrus.Fields{
			"URL": "https://github.com/khulnasoft/shipyard/issues/14705",
		}).Infof(
