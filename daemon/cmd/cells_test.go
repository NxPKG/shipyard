...
var goleakOptions = []goleak.Option{
	...
	goleak.IgnoreTopFunction("github.com/khulnasoft/shipyard/pkg/identity/cache.(*identityWatcher).watch.func1"),
	goleak.IgnoreTopFunction("github.com/khulnasoft/shipyard/pkg/trigger.(*Trigger).waiter"),
}
