...
import (
	...
	health "github.com/khulnasoft/shipyard/cilium-health/launch"
	"github.com/khulnasoft/shipyard/daemon/cmd/cni"
	agentK8s "github.com/khulnasoft/shipyard/daemon/k8s"
	"github.com/khulnasoft/shipyard/pkg/auth"
	"github.com/khulnasoft/shipyard/pkg/bandwidth"
	"github.com/khulnasoft/shipyard/pkg/bgp/speaker"
	bgpv1 "github.com/khulnasoft/shipyard/pkg/bgpv1/agent"
	"github.com/khulnasoft/shipyard/pkg/bpf"
	"github.com/khulnasoft/shipyard/pkg/cgroups/manager"
	"github.com/khulnasoft/shipyard/pkg/cidr"
	"github.com/khulnasoft/shipyard/pkg/clustermesh"
	"github.com/khulnasoft/shipyard/pkg/controller"
	"github.com/khulnasoft/shipyard/pkg/counter"
	"github.com/khulnasoft/shipyard/pkg/datapath/link"
	linuxdatapath "github.com/khulnasoft/shipyard/pkg/datapath/linux"
	"github.com/khulnasoft/shipyard/pkg/datapath/linux/bigtcp"
	"github.com/khulnasoft/shipyard/pkg/datapath/linux/ipsec"
	"github.com/khulnasoft/shipyard/pkg/datapath/linux/probes"
	linuxrouting "github.com/khulnasoft/shipyard/pkg/datapath/linux/routing"
	"github.com/khulnasoft/shipyard/pkg/datapath/loader"
	datapathOption "github.com/khulnasoft/shipyard/pkg/datapath/option"
	datapath "github.com/khulnasoft/shipyard/pkg/datapath/types"
	"github.com/khulnasoft/shipyard/pkg/debug"
	"github.com/khulnasoft/shipyard/pkg/defaults"
	"github.com/khulnasoft/shipyard/pkg/egressgateway"
	"github.com/khulnasoft/shipyard/pkg/endpoint"
	"github.com/khulnasoft/shipyard/pkg/endpoint/regeneration"
	"github.com/khulnasoft/shipyard/pkg/endpointmanager"
	"github.com/khulnasoft/shipyard/pkg/eventqueue"
	"github.com/khulnasoft/shipyard/pkg/fqdn"
	"github.com/khulnasoft/shipyard/pkg/hive/cell"
	"github.com/khulnasoft/shipyard/pkg/hubble/observer"
	"github.com/khulnasoft/shipyard/pkg/identity"
	"github.com/khulnasoft/shipyard/pkg/identity/identitymanager"
	"github.com/khulnasoft/shipyard/pkg/ipam"
	ipamMetadata "github.com/khulnasoft/shipyard/pkg/ipam/metadata"
	ipamOption "github.com/khulnasoft/shipyard/pkg/ipam/option"
	"github.com/khulnasoft/shipyard/pkg/ipcache"
	ipcachetypes "github.com/khulnasoft/shipyard/pkg/ipcache/types"
	...
	"github.com/khulnasoft/shipyard/pkg/k8s/watchers"
	"github.com/khulnasoft/shipyard/pkg/l2announcer"
	...
	"github.com/khulnasoft/shipyard/pkg/mtu"
	"github.com/khulnasoft/shipyard/pkg/node"
	nodeTypes "github.com/khulnasoft/shipyard/pkg/node/types"
	"github.com/khulnasoft/shipyard/pkg/nodediscovery"
	"github.com/khulnasoft/shipyard/pkg/option"
	"github.com/khulnasoft/shipyard/pkg/policy"
	policyAPI "github.com/khulnasoft/shipyard/pkg/policy/api"
	"github.com/khulnasoft/shipyard/pkg/proxy"
	"github.com/khulnasoft/shipyard/pkg/rate"
	"github.com/khulnasoft/shipyard/pkg/recorder"
	"github.com/khulnasoft/shipyard/pkg/redirectpolicy"
	"github.com/khulnasoft/shipyard/pkg/resiliency"
	"github.com/khulnasoft/shipyard/pkg/service"
	serviceStore "github.com/khulnasoft/shipyard/pkg/service/store"
	"github.com/khulnasoft/shipyard/pkg/source"
	"github.com/khulnasoft/shipyard/pkg/status"
	"github.com/khulnasoft/shipyard/pkg/trigger"
)
...
func newDaemon(ctx context.Context, cleaner *daemonCleanup, params *daemonParams) (*Daemon, *endpointRestoreState, error) {
	...
	if option.Config.BGPAnnounceLBIP || option.Config.BGPAnnouncePodCIDR {
		log.WithField("url", "https://github.com/khulnasoft/shipyard/issues/22246").
