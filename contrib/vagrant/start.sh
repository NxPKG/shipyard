...
function write_k8s_install() {
    ...
    cat <<EOF >> "${filename}"
# K8s
k8s_path="/home/vagrant/go/src/github.com/khulnasoft/shipyard/contrib/vagrant/scripts"
...
/home/vagrant/go/src/github.com/khulnasoft/shipyard/test/provision/wait-cilium.sh
EOF
}
