...
import (
	...
	"github.com/khulnasoft/shipyard/pkg/allocator"
	...
	"github.com/khulnasoft/shipyard/pkg/identity/cache"
	cacheKey "github.com/khulnasoft/shipyard/pkg/identity/key"
	"github.com/khulnasoft/shipyard/pkg/idpool"
	ciliumClient "github.com/khulnasoft/shipyard/pkg/k8s/apis/cilium.io/client"
	k8sClient "github.com/khulnasoft/shipyard/pkg/k8s/client"
	"github.com/khulnasoft/shipyard/pkg/k8s/identitybackend"
	"github.com/khulnasoft/shipyard/pkg/kvstore"
	kvstoreallocator "github.com/khulnasoft/shipyard/pkg/kvstore/allocator"
...
func migrateIdentityCmd() *cobra.Command {
	...
	hive := hive.New(
		...
		cell.Invoke(func(lc hive.Lifecycle, clientset k8sClient.Clientset, resources agentK8s.LocalNodeResources, shutdowner hive.Shutdowner) {
			lc.Append(hive.Hook{
...
func migrateIdentities(ctx hive.HookContext, clientset k8sClient.Clientset, resources agentK8s.LocalNodeResources, shutdowner hive.Shutdowner) error {
