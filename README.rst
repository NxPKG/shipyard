...
+---------------------------------------------------------+------------+------------------------------------+----------------------------------------------------------------------------+
| `v1.14 <https://github.com/khulnasoft/shipyard/tree/v1.14>`__ | 2023-10-18 | ``quay.io/cilium/cilium:v1.14.3``  | `Release Notes <https://github.com/khulnasoft/shipyard/releases/tag/v1.14.3>`__  |
+---------------------------------------------------------+------------+------------------------------------+----------------------------------------------------------------------------+
| `v1.13 <https://github.com/khulnasoft/shipyard/tree/v1.13>`__ | 2023-10-17 | ``quay.io/cilium/cilium:v1.13.8``  | `Release Notes <https://github.com/khulnasoft/shipyard/releases/tag/v1.13.8>`__  |
+---------------------------------------------------------+------------+------------------------------------+----------------------------------------------------------------------------+
| `v1.12 <https://github.com/khulnasoft/shipyard/tree/v1.12>`__ | 2023-10-17 | ``quay.io/cilium/cilium:v1.12.15`` | `Release Notes <https://github.com/khulnasoft/shipyard/releases/tag/v1.12.15>`__ |
+---------------------------------------------------------+------------+------------------------------------+----------------------------------------------------------------------------+
...
branch <https://github.com/khulnasoft/shipyard/commits/main>`_. These images are
...
+--------------------------------------------------------------------------------------+------------+----------------------------------------------+-------------------------------------------------------------------------------------------+
| `main <https://github.com/khulnasoft/shipyard/commits/main>`__                             | daily      | ``quay.io/cilium/cilium-ci:latest``          | N/A                                                                                       |
+--------------------------------------------------------------------------------------+------------+----------------------------------------------+-------------------------------------------------------------------------------------------+
| `v1.15.0-pre.1 <https://github.com/khulnasoft/shipyard/commits/v1.15.0-pre.1>`__           | 2023-09-30 | ``quay.io/cilium/cilium:v1.15.0-pre.1``      | `Release Candidate Notes <https://github.com/khulnasoft/shipyard/releases/tag/v1.15.0-pre.1>`__ |
+--------------------------------------------------------------------------------------+------------+----------------------------------------------+-------------------------------------------------------------------------------------------+
...
.. _Hubble: https://github.com/khulnasoft/hubble/
...
.. _`Frequently Asked Questions`: https://github.com/khulnasoft/shipyard/issues?utf8=%E2%9C%93&q=is%3Aissue+label%3Akind%2Fquestion+
...
.. |go-report| image:: https://goreportcard.com/badge/github.com/khulnasoft/shipyard
    :alt: Go Report Card
    :target: https://goreportcard.com/report/github.com/khulnasoft/shipyard

.. |go-doc| image:: https://godoc.org/github.com/khulnasoft/shipyard?status.svg
    :alt: GoDoc
    :target: https://godoc.org/github.com/khulnasoft/shipyard
