...
import (
	...
	slim_discovery_v1 "github.com/khulnasoft/shipyard/pkg/k8s/slim/k8s/api/discovery/v1"
	slim_discovery_v1beta1 "github.com/khulnasoft/shipyard/pkg/k8s/slim/k8s/api/discovery/v1beta1"
