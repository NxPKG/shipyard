...
import (
	...
	scheme "github.com/khulnasoft/shipyard/pkg/k8s/slim/k8s/apiextensions-client/clientset/versioned/scheme"
	v1 "github.com/khulnasoft/shipyard/pkg/k8s/slim/k8s/apis/apiextensions/v1"
