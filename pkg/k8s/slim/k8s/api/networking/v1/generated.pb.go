...
// source: github.com/khulnasoft/shipyard/pkg/k8s/slim/k8s/api/networking/v1/generated.proto
...
import (
	...
	github_com_cilium_cilium_pkg_k8s_slim_k8s_api_core_v1 "github.com/khulnasoft/shipyard/pkg/k8s/slim/k8s/api/core/v1"
	v1 "github.com/khulnasoft/shipyard/pkg/k8s/slim/k8s/apis/meta/v1"
	intstr "github.com/khulnasoft/shipyard/pkg/k8s/slim/k8s/apis/util/intstr"
...
func init() {
	proto.RegisterFile("github.com/khulnasoft/shipyard/pkg/k8s/slim/k8s/api/networking/v1/generated.proto", fileDescriptor_5d3be2d57d520df2)
}
