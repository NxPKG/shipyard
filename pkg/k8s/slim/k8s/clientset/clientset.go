...
import (
	...
	slim_corev1 "github.com/khulnasoft/shipyard/pkg/k8s/slim/k8s/client/clientset/versioned/typed/core/v1"
	slim_discovery_v1 "github.com/khulnasoft/shipyard/pkg/k8s/slim/k8s/client/clientset/versioned/typed/discovery/v1"
	slim_discovery_v1beta1 "github.com/khulnasoft/shipyard/pkg/k8s/slim/k8s/client/clientset/versioned/typed/discovery/v1beta1"
	slim_networkingv1 "github.com/khulnasoft/shipyard/pkg/k8s/slim/k8s/client/clientset/versioned/typed/networking/v1"
)
