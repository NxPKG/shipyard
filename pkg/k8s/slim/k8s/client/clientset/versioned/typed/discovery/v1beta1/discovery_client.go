...
import (
	...
	v1beta1 "github.com/khulnasoft/shipyard/pkg/k8s/slim/k8s/api/discovery/v1beta1"
	"github.com/khulnasoft/shipyard/pkg/k8s/slim/k8s/client/clientset/versioned/scheme"
