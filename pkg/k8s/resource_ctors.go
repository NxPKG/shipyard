...
import (
	...
	slim_discoveryv1 "github.com/khulnasoft/shipyard/pkg/k8s/slim/k8s/api/discovery/v1"
	slim_discoveryv1beta1 "github.com/khulnasoft/shipyard/pkg/k8s/slim/k8s/api/discovery/v1beta1"
	slim_networkingv1 "github.com/khulnasoft/shipyard/pkg/k8s/slim/k8s/api/networking/v1"
	"github.com/khulnasoft/shipyard/pkg/k8s/types"
	"github.com/khulnasoft/shipyard/pkg/k8s/utils"
	"github.com/khulnasoft/shipyard/pkg/k8s/version"
)
