...
import (
	...
	hubblemetrics "github.com/khulnasoft/shipyard/pkg/hubble/metrics"
	...
	"github.com/khulnasoft/shipyard/pkg/k8s/informer"
	"github.com/khulnasoft/shipyard/pkg/k8s/resource"
	slim_corev1 "github.com/khulnasoft/shipyard/pkg/k8s/slim/k8s/api/core/v1"
	slim_metav1 "github.com/khulnasoft/shipyard/pkg/k8s/slim/k8s/apis/meta/v1"
	slimclientset "github.com/khulnasoft/shipyard/pkg/k8s/slim/k8s/client/clientset/versioned"
	k8sTypes "github.com/khulnasoft/shipyard/pkg/k8s/types"
	k8sUtils "github.com/khulnasoft/shipyard/pkg/k8s/utils"
	"github.com/khulnasoft/shipyard/pkg/k8s/watchers/resources"
	"github.com/khulnasoft/shipyard/pkg/k8s/watchers/utils"
	...
	ciliumTypes "github.com/khulnasoft/shipyard/pkg/types"
...
func (k *K8sWatcher) deleteHostPortMapping(pod *slim_corev1.Pod, podIPs []string) error {
	...
	for _, dpSvc := range svcs {
		...
		// See: https://github.com/khulnasoft/shipyard/issues/22460.
