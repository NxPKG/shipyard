...
import (
	...
	cilium_v2_alpha1 "github.com/khulnasoft/shipyard/pkg/k8s/apis/cilium.io/v2alpha1"
	"github.com/khulnasoft/shipyard/pkg/k8s/client"
	clientset "github.com/khulnasoft/shipyard/pkg/k8s/client/clientset/versioned"
	"github.com/khulnasoft/shipyard/pkg/k8s/resource"
	"github.com/khulnasoft/shipyard/pkg/k8s/types"
	...
	"github.com/khulnasoft/shipyard/pkg/spanstat"
)
...
func (k *K8sWatcher) onUpsert(
	...
	// fields.
	// See https://github.com/khulnasoft/shipyard/blob/27fee207f5422c95479422162e9ea0d2f2b6c770/pkg/policy/api/ingress.go#L112-L134
	cnpCpy := cnp.DeepCopy()
