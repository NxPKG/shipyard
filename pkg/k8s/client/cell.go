...
import (
	...
	cilium_clientset "github.com/khulnasoft/shipyard/pkg/k8s/client/clientset/versioned"
	cilium_fake "github.com/khulnasoft/shipyard/pkg/k8s/client/clientset/versioned/fake"
	k8smetrics "github.com/khulnasoft/shipyard/pkg/k8s/metrics"
	slim_apiextclientsetscheme "github.com/khulnasoft/shipyard/pkg/k8s/slim/k8s/apiextensions-client/clientset/versioned/scheme"
	slim_apiext_clientset "github.com/khulnasoft/shipyard/pkg/k8s/slim/k8s/apiextensions-clientset"
	slim_metav1 "github.com/khulnasoft/shipyard/pkg/k8s/slim/k8s/apis/meta/v1"
	slim_metav1beta1 "github.com/khulnasoft/shipyard/pkg/k8s/slim/k8s/apis/meta/v1beta1"
	slim_clientset "github.com/khulnasoft/shipyard/pkg/k8s/slim/k8s/client/clientset/versioned"
	slim_fake "github.com/khulnasoft/shipyard/pkg/k8s/slim/k8s/client/clientset/versioned/fake"
