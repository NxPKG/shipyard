...
import (
	v2 "github.com/khulnasoft/shipyard/pkg/k8s/client/informers/externalversions/cilium.io/v2"
	v2alpha1 "github.com/khulnasoft/shipyard/pkg/k8s/client/informers/externalversions/cilium.io/v2alpha1"
