...
import (
	...
	envoy_service_cluster "github.com/khulnasoft/proxy/go/envoy/service/cluster/v3"
	envoy_service_discovery "github.com/khulnasoft/proxy/go/envoy/service/discovery/v3"
	envoy_service_endpoint "github.com/khulnasoft/proxy/go/envoy/service/endpoint/v3"
	envoy_service_listener "github.com/khulnasoft/proxy/go/envoy/service/listener/v3"
	envoy_service_route "github.com/khulnasoft/proxy/go/envoy/service/route/v3"
	envoy_service_secret "github.com/khulnasoft/proxy/go/envoy/service/secret/v3"
...
func startXDSGRPCServer(listener net.Listener, config map[string]*xds.ResourceTypeConfiguration) context.CancelFunc {
	...
	// TODO: https://github.com/khulnasoft/shipyard/issues/5051
