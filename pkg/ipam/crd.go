...
import (
	...
	alibabaCloud "github.com/khulnasoft/shipyard/pkg/alibabacloud/utils"
	...
	case ipamOption.IPAMAzure:
		for _, iface := range a.store.ownNode.Status.Azure.Interfaces {
			if iface.ID == ipInfo.Resource {
				...
				// https://github.com/khulnasoft/shipyard/issues/15496.
				//
				// TODO: Once https://github.com/khulnasoft/shipyard/issues/14705 is
