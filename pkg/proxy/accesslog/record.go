...
type LogRecordDNS struct {
	...
	// Use 	github.com/khulnasoft/dns.RcodeToString map to retrieve string representation
	RCode int `json:"RCode,omitempty"`

	// QTypes are question types in DNS message
	// https://www.ietf.org/rfc/rfc1035.txt
	// Use github.com/khulnasoft/dns.TypeToString map to retrieve string representation
