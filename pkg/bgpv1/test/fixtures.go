...
import (
	...
	daemon_k8s "github.com/khulnasoft/shipyard/daemon/k8s"
	"github.com/khulnasoft/shipyard/pkg/annotation"
	"github.com/khulnasoft/shipyard/pkg/bgpv1"
	"github.com/khulnasoft/shipyard/pkg/bgpv1/agent"
	...
	k8sPkg "github.com/khulnasoft/shipyard/pkg/k8s"
	cilium_api_v2 "github.com/khulnasoft/shipyard/pkg/k8s/apis/cilium.io/v2"
	cilium_api_v2alpha1 "github.com/khulnasoft/shipyard/pkg/k8s/apis/cilium.io/v2alpha1"
	k8sClient "github.com/khulnasoft/shipyard/pkg/k8s/client"
	"github.com/khulnasoft/shipyard/pkg/k8s/client/clientset/versioned/typed/cilium.io/v2alpha1"
	"github.com/khulnasoft/shipyard/pkg/k8s/resource"
	slim_core_v1 "github.com/khulnasoft/shipyard/pkg/k8s/slim/k8s/api/core/v1"
	slim_meta_v1 "github.com/khulnasoft/shipyard/pkg/k8s/slim/k8s/apis/meta/v1"
	clientset_core_v1 "github.com/khulnasoft/shipyard/pkg/k8s/slim/k8s/client/clientset/versioned/typed/core/v1"
	"github.com/khulnasoft/shipyard/pkg/k8s/utils"
	"github.com/khulnasoft/shipyard/pkg/node"
	"github.com/khulnasoft/shipyard/pkg/node/types"
