...
import (
	...
	pb "github.com/khulnasoft/shipyard/api/v1/flow"
	"github.com/khulnasoft/shipyard/pkg/hubble/metrics/api"
	_ "github.com/khulnasoft/shipyard/pkg/hubble/metrics/dns"               // invoke init
	_ "github.com/khulnasoft/shipyard/pkg/hubble/metrics/drop"              // invoke init
	_ "github.com/khulnasoft/shipyard/pkg/hubble/metrics/flow"              // invoke init
	_ "github.com/khulnasoft/shipyard/pkg/hubble/metrics/flows-to-world"    // invoke init
	_ "github.com/khulnasoft/shipyard/pkg/hubble/metrics/http"              // invoke init
	_ "github.com/khulnasoft/shipyard/pkg/hubble/metrics/icmp"              // invoke init
	_ "github.com/khulnasoft/shipyard/pkg/hubble/metrics/kafka"             // invoke init
	_ "github.com/khulnasoft/shipyard/pkg/hubble/metrics/policy"            // invoke init
	_ "github.com/khulnasoft/shipyard/pkg/hubble/metrics/port-distribution" // invoke init
	_ "github.com/khulnasoft/shipyard/pkg/hubble/metrics/tcp"               // invoke init
