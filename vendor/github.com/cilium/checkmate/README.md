...
`defeat` is meant to ease migrating off of `gopkg.in/check.v1`
...
```sh
$ go mod edit -replace=gopkg.in/check.v1=github.com/khulnasoft/defeat
```
...
import check "github.com/khulnasoft/defeat"
```
