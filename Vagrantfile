...
# https://github.com/khulnasoft/shipyard/pull/12520
...
if [ -x /home/vagrant/go/src/github.com/khulnasoft/shipyard/.devvmrc ] ; then
   echo "----------------------------------------------------------------"
   echo "Executing .devvmrc"
   /home/vagrant/go/src/github.com/khulnasoft/shipyard/.devvmrc || true
fi
...
echo 'cd ~/go/src/github.com/khulnasoft/shipyard' >> /home/vagrant/.bashrc
echo 'export GOPATH=$(go env GOPATH)' >> /home/vagrant/.bashrc
chown -R vagrant:vagrant /home/vagrant 2>/dev/null || true
curl -SsL https://github.com/khulnasoft/bpf-map/releases/download/v1.0/bpf-map -o bpf-map
chmod +x bpf-map
mv bpf-map /usr/bin
SCRIPT
...
export PATH=/home/vagrant/go/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/games:/usr/local/games
#{$makeclean}
~/go/src/github.com/khulnasoft/shipyard/contrib/vagrant/build.sh
rm -fr ~/go/bin/cilium*
SCRIPT
...
# "fatal: unsafe repository ('/home/vagrant/go/src/github.com/khulnasoft/shipyard' is owned by someone else)"
# error condition when running `sudo make install`
git config --global --add safe.directory /home/vagrant/go/src/github.com/khulnasoft/shipyard

sudo -E make -C /home/vagrant/go/src/github.com/khulnasoft/shipyard/ install

sudo mkdir -p /etc/sysconfig
sudo cp /home/vagrant/go/src/github.com/khulnasoft/shipyard/contrib/systemd/cilium-consul.service /lib/systemd/system
sudo cp /home/vagrant/go/src/github.com/khulnasoft/shipyard/contrib/systemd/cilium-docker.service /lib/systemd/system
sudo cp /home/vagrant/go/src/github.com/khulnasoft/shipyard/contrib/systemd/cilium-etcd.service /lib/systemd/system
sudo cp /home/vagrant/go/src/github.com/khulnasoft/shipyard/contrib/systemd/cilium.service /lib/systemd/system
sudo cp /home/vagrant/go/src/github.com/khulnasoft/shipyard/contrib/systemd/cilium-operator.service /lib/systemd/system
sudo cp /home/vagrant/go/src/github.com/khulnasoft/shipyard/contrib/systemd/cilium /etc/sysconfig
...
Vagrant.configure(2) do |config|
    ...
    cilium_dir = '.'
    cilium_path = '/home/vagrant/go/src/github.com/khulnasoft/shipyard'
    if ENV["SHARE_PARENT"] == "2" then
      cilium_dir = '../..'
      cilium_path = '/home/vagrant/go/src/github.com'
    elsif ENV["SHARE_PARENT"] then
      cilium_dir = '..'
      cilium_path = '/home/vagrant/go/src/github.com/khulnasoft'
    end
