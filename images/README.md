...
Some of these images are built on top of [`cilium/image-tools`](https://github.com/khulnasoft/image-tools),
anyone reading this document should also read [`cilium/image-tools` documentation](https://github.com/khulnasoft/image-tools/blob/master/README.md).
...
This image is based on [`bpftool`](https://github.com/khulnasoft/image-tools#imagesbpftool),
and [`llvm`](https://github.com/khulnasoft/image-tools#imagesllvm) from `cilium/image-tools`.
...
[`cilium/image-tools` documentation](https://github.com/khulnasoft/image-tools#usage)
for details).
...
tool (see [`cilium/image-tools` docs for details](https://github.com/khulnasoft/image-tools#imagestester)).
...
RUN --mount=type=bind,readwrite,target=/go/src/github.com/khulnasoft/shipyard --mount=target=/root/.cache,type=cache --mount=target=/go/pkg/mod,type=cache \
